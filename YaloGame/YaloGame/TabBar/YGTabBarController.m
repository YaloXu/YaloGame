...
//
//    self.item2Image = [[UIImageView alloc]initWithFrame:CGRectMake((kScreenWidth-ItemSize)/2, -30, ItemSize, ItemSize)];
//    self.item2Image.image = [UIImage imageNamed:@"tabbar_discovery"];
//    self.item2Image.contentMode = UIViewContentModeCenter;
//    self.delegate = self;
//
...
- (UINavigationController *)navigationControllerWithRootController:(UIViewController *)controller {
    UINavigationController *nav = [[YGBaseNavgationViewController alloc] initWithRootViewController:controller];
    return nav;
}
@end
