...
- (void)addSubVC {
    ...
    self.disconveryNav = [self navigationControllerWithRootController:disconveryVC];
    ...
    self.viewControllers = @[homeNav,accountNav,self.disconveryNav,messageNav,mineNav];
    ...
    self.disconveryNav.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"发现" image:nil selectedImage:nil];
